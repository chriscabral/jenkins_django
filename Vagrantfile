...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "chriscabral-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/myth"
  #   chef.validation_client_name = "myth-validator"
  #   chef.validation_key_path = ".chef/myth-validator.pem"
  # end
end
